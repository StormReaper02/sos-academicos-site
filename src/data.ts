...
export const TESTIMONIALS: TestimonialItem[] = [
  ...
  },
  {
    ...
    name: 'Raina Maria',
    course: 'Pedagogia',
    image: '/assets/avatar_raina.jpg',
    rating: 5,
    text: 'Encontrei o serviço através de uma amiga enquanto ainda estava na graduação. Nos momentos de bloqueio criativo, de desespero com trabalhos e TCC, eu sabia onde recorrer. Excelente orientação e correções. Recomendo. Serviço feito com comprometimento e qualidade.',
    linkUrl: 'https://www.instagram.com/p/DSIIXqHEeG_/',
    verified: true,
  },
  {
  ...
  },
  {
    ...
    course: 'Professor de Ciências - Física - Matemática',
    image: '/assets/avatar_leandro.jpg',
    rating: 5,
    text: 'Recomendo muito, ela me ajudou com a confecção de dois projetos de mestrado (que ficaram excelentes por sinal): revisão bibliográfica, levantamento de dados, formatação em ABNT… quando estiver precisando de servições nesse sentido, só entre em contato com esse perfil que ele vai te atender muito bem e o trabalho final fica impecável!!!',
    linkUrl: 'https://www.instagram.com/p/C6prczEOTgm/',
    verified: true,
  },
  {
    id: '5',
    name: 'Zaiane Maia',
    course: 'Acadêmica de Nutrição',
    image: '/assets/avatar_zaiane.jpg',
    rating: 5,
    text: 'Equipe maravilhosa, trabalho com compromisso, pontualidade e responsabilidade. Essa equipe eu recomendo!',
    linkUrl: 'https://www.instagram.com/p/DY7-C1zBSUO/',
    verified: true,
  },
];
